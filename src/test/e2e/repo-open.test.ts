...
const MOCK_BRANCHES: BranchInfo[] = [
  { name: "main", is_head: true, is_remote: false, oid: "abc123def456abc123def456abc123def456abc1" },
  { name: "feature/cool", is_head: false, is_remote: false, oid: "def456abc123def456abc123def456abc123def4" },
  { name: "origin/main", is_head: false, is_remote: true, oid: "abc123def456abc123def456abc123def456abc1" },
];
