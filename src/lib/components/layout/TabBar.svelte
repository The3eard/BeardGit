    ...
    <div class="terminal-split" bind:this={terminalMenuRef}>
      ...
      {#if terminalMenuOpen}
        <div class="terminal-menu">
          ...
          <button class="terminal-menu-item" onclick={handleTerminalClaude}>
          ...
          <button class="terminal-menu-item" onclick={handleTerminalCodex}>
          ...
          <button class="terminal-menu-item" onclick={handleTerminalOpenCode}>
