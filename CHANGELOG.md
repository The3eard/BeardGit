...
## [26.9.3] — A conflict editor that scrolls through the block — 2026-09-21
...
- **`rustls` moves to 0.23.45.** RUSTSEC-2026-0285: TLS 1.3 handshake messages were accepted across encryption level boundaries. The crate reaches the app through the HTTP client behind the GitHub and GitLab integrations; lockfile-only bump.
